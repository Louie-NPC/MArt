...
import com.example.martapplication.Utils.Companion.MESSAGE_LEFT
import com.example.martapplication.Utils.Companion.MESSAGE_RIGHT
...
class MessageAdapter : RecyclerView.Adapter<MessageHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessageHolder {
        ...
        return if (viewType == RIGHT) {
            val view = inflater.inflate(R.layout.chatright, parent, false)
            MessageHolder(view)
        } else {
            val view = inflater.inflate(R.layout.chatleft, parent, false)
            MessageHolder(view)
        }
    }
